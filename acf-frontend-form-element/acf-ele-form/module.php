...
class ACFEF_Module extends Module
{
    ...
    public function acfef_enqueue_scripts()
    {
        ...
        wp_register_style(
            'paypal-editor',
            ACFEF_URL . 'acf-ele-form/assets/css/paypal-editor.css',
            [],
            '1.0.0'
        );
        wp_register_style(
            'paypal-front',
            ACFEF_URL . 'acf-ele-form/assets/css/paypal-front.css',
            [],
            '1.0.0'
        );
    ...
    public function acfef_edit_mode_scripts()
    {
        ...
        if ( isset( get_option( 'stripe_settings_option_name' )['acfef_stripe_active'] ) && \Elementor\Plugin::$instance->preview->is_preview_mode() ) {
            ...
            wp_register_style(
                'acfef-card',
                ACFEF_URL . 'acf-ele-form/assets/css/card.css',
                array(),
                '5.5.25'
            );
            wp_register_script(
                'acfef-card',
                ACFEF_URL . 'acf-ele-form/assets/js/card.js',
                array( 'jquery' ),
                '5.5.15',
                true
            );
            ...
            wp_register_script(
                ...
                ACFEF_URL . 'acf-ele-form/assets/js/stripe-handler.js',
                array( 'jquery', 'stripe', 'acfef-card' ),
                '5.5.18',
                true
            );
            if ( $spk_localized ) {
    ...
    public function acfef_icon_file()
    {
        wp_enqueue_style(
            'acfef-icon',
            ACFEF_URL . 'acf-ele-form/assets/css/icon.css',
            array(),
            '1.0.0'
        );
    }
